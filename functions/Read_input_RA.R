data_input_RA <- function(Input, Index, type){
  taxa_tmp <- c("Whole", "Phylum", "Class", "Order", "Family", "Genus", "Species")
  ...
  text_OTU_summary<- paste("RA of ", nrow(data_tmp), " bacterial taxa at the ", taxa_tmp[as.numeric(type)], " level.", sep="")
