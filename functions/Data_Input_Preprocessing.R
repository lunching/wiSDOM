data_input_pre_proc <- function(Input, Index, NA_cut, zero_cut){
  ...
  text_NA_summary <- paste("There are ", length(index_NA), " Biomarker(s) with missing rate greater than ", NA_cut_tmp, " in any one of ", length(index_tmp), " groups", sep="")
  ...
  text_zero_summary <- paste("There are ", length(index_zero), " Biomarker(s) with number of 0 rate greater than ", zero_cut_tmp, " in any one of ", length(index_tmp), " groups", sep="")
  if(nrow(data_OTU3) == 0){
    ...
    text_sd_summary <- paste("There are ", length(index_sd), " Biomarker(s) with standard deviation equals to 0 in any one of ", length(index_tmp), " groups", sep="")
